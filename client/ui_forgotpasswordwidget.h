/********************************************************************************
** Form generated from reading ui file 'forgotpasswordwidget.ui'
**
...
#ifndef UI_FORGOTPASSWORDWIDGET_H
#define UI_FORGOTPASSWORDWIDGET_H
...
class Ui_ForgotPasswordWidgetClass
{
public:
    QFrame *frame_2;
    ...
    void setupUi(QWidget *ForgotPasswordWidgetClass)
    {
        if (ForgotPasswordWidgetClass->objectName().isEmpty())
            ForgotPasswordWidgetClass->setObjectName(QString::fromUtf8("ForgotPasswordWidgetClass"));
        ForgotPasswordWidgetClass->setWindowModality(Qt::NonModal);
        ForgotPasswordWidgetClass->resize(388, 267);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(ForgotPasswordWidgetClass->sizePolicy().hasHeightForWidth());
        ForgotPasswordWidgetClass->setSizePolicy(sizePolicy);
        frame_2 = new QFrame(ForgotPasswordWidgetClass);
        ...
        topTitleFrame->setMaximumSize(QSize(16777215, 32));
        ...
        loginLabel->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
        ...
        topTitleFrame->raise();
        transBorder_4 = new QFrame(ForgotPasswordWidgetClass);
        ...
        transBorder = new QFrame(ForgotPasswordWidgetClass);
        ...
        transBorder_2 = new QFrame(ForgotPasswordWidgetClass);
        ...
        transBorder_3 = new QFrame(ForgotPasswordWidgetClass);
        ...
        retranslateUi(ForgotPasswordWidgetClass);

        QMetaObject::connectSlotsByName(ForgotPasswordWidgetClass);
    } // setupUi

    void retranslateUi(QWidget *ForgotPasswordWidgetClass)
    {
#ifndef QT_NO_ACCESSIBILITY
        titleLabel->setAccessibleName(QApplication::translate("ForgotPasswordWidgetClass", "redLabel", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_ACCESSIBILITY
        titleLabel->setText(QApplication::translate("ForgotPasswordWidgetClass", "Title", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_ACCESSIBILITY
        loginLabel->setAccessibleName(QApplication::translate("ForgotPasswordWidgetClass", "whiteLabel", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_ACCESSIBILITY
        loginLabel->setText(QApplication::translate("ForgotPasswordWidgetClass", "Login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_ACCESSIBILITY
        backButton->setAccessibleName(QApplication::translate("ForgotPasswordWidgetClass", "blueButton", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_ACCESSIBILITY
        backButton->setText(QApplication::translate("ForgotPasswordWidgetClass", "Back", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_ACCESSIBILITY
        nextButton->setAccessibleName(QApplication::translate("ForgotPasswordWidgetClass", "blueButton", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_ACCESSIBILITY
        nextButton->setText(QApplication::translate("ForgotPasswordWidgetClass", "Next", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_ACCESSIBILITY
        transBorder_4->setAccessibleName(QApplication::translate("ForgotPasswordWidgetClass", "transBorder", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_ACCESSIBILITY
#ifndef QT_NO_ACCESSIBILITY
        transBorder->setAccessibleName(QApplication::translate("ForgotPasswordWidgetClass", "transBorder", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_ACCESSIBILITY
#ifndef QT_NO_ACCESSIBILITY
        transBorder_2->setAccessibleName(QApplication::translate("ForgotPasswordWidgetClass", "transBorder", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_ACCESSIBILITY
#ifndef QT_NO_ACCESSIBILITY
        transBorder_3->setAccessibleName(QApplication::translate("ForgotPasswordWidgetClass", "transBorder", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_ACCESSIBILITY
        Q_UNUSED(ForgotPasswordWidgetClass);
    } // retranslateUi

};

namespace Ui {
    class ForgotPasswordWidgetClass: public Ui_ForgotPasswordWidgetClass {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FORGOTPASSWORDWIDGET_H
