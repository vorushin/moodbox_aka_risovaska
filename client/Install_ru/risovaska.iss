...
#define MyAppName "Рисоваська"
#define MyAppVerName "Рисоваська 1.4.5 бета"
#define MyAppVersion "1.4.5.0"
#define MyAppSetupName "RisovaskaSetup"
#define MyAppPublisher "ООО Инструменты живого общения"
#define MyAppURL "http://risovaska.ru/"
#define MyAppExeName "risovaska.exe"
...
Name: ru; MessagesFile: compiler:Languages\russian_risovaska.isl; LicenseFile: eula-ru.rtf
...
[Files]
Source: {#AppDir}\{#MyAppExeName}; DestDir: {app}; Flags: ignoreversion {#StdFilesFlags}; BeforeInstall: BeforeMyProgInstall('risovaska.exe')
...
begin
  ...
  while 1 = 1 do begin
    if FileExists(ExeFile) and not DeleteFile(ExeFile) then begin
      MsgBox('Рисоваська запущена' #13#13 'Выйдите, пожалуйста, из Рисоваськи и нажмите OK', mbInformation, MB_OK);
    end else begin
      break;
        end;
  end;
