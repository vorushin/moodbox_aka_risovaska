...
; *** SetupLdr messages
SetupLdrStartupMessage=Данная программа установит Рисоваську на Ваш компьютер, продолжить?
...
; *** "Welcome" wizard page
WelcomeLabel1=Вас приветствует Мастер установки Рисоваськи
WelcomeLabel2=Программа установит Рисоваську на Ваш компьютер.%n%nЕсли Вы уже пользуетесь Рисоваськой - закройте её перед продолжением установки.
...
SelectDirDesc=В какую папку Вы хотите установить Рисоваську?
SelectDirLabel3=Программа установит Рисоваську в следующую папку.
...
SelectTasksLabel2=Выберите дополнительные задачи, которые должны выполниться при установке Рисоваськи, после этого нажмите «Далее»:
...
ReadyLabel1=Программа установки готова начать установку Рисоваськи на Ваш компьютер.
...
PreparingDesc=Программа установки подготавливается к установке Рисоваськи на Ваш компьютер.
PreviousInstallNotCompleted=Установка или удаление предыдущей программы не были завершены. Вам потребуется перезагрузить Ваш компьютер, чтобы завершить ту установку.%n%nПосле перезагрузки запустите вновь Программу установки, чтобы завершить установку Рисоваськи.
...
FinishedLabelNoIcons=Рисоваська установлена на Ваш компьютер.
FinishedLabel=Рисоваська установлена на Ваш компьютер. Приложение можно запустить с помощью соответствующего значка.
ClickFinish=Нажмите «Завершить», чтобы выйти из программы установки.
FinishedRestartLabel=Для завершения установки Рисоваськи требуется перезагрузить компьютер. Произвести перезагрузку сейчас?
FinishedRestartMessage=Для завершения установки Рисоваськи требуется перезагрузить компьютер.%n%nПроизвести перезагрузку сейчас?
...
ConfirmUninstall=Вы действительно хотите удалить Рисоваську и все компоненты программы?
...
UninstalledMost=Деинсталляция Рисоваськи завершена.%n%nЧасть элементов не удалось удалить. Вы можете удалить их самостоятельно.
UninstalledAndNeedsRestart=Для завершения деинсталляции Рисоваськи необходимо произвести перезагрузку Вашего компьютера.%n%nВыполнить перезагрузку сейчас?
...
StatusUninstalling=Деинсталляция Рисоваськи...
...
ProgramOnTheWeb=Сайт risovaska.ru
UninstallProgram=Удалить Рисоваську
LaunchProgram=Запустить Рисоваську
AssocFileExtension=Св&язать Рисоваську с файлами, имеющими расширение %2
AssocingFileExtension=Связывание Рисоваськи с файлами %2...